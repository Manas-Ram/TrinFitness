...
db.serialize(() => {
    ...
    menuOptions.forEach(option => {
        db.run("INSERT INTO menu_options (week, name, calories, protein, carbs, fat) VALUES (?, ?, ?, ?, ?, ?)", 
            [option.week, option.name, option.calories, option.protein, option.carbs, option.fat]);
    });
});
