...
db.serialize(() => {
    db.run("CREATE TABLE IF NOT EXISTS users (id INTEGER PRIMARY KEY, email TEXT, role TEXT, isAdmin BOOLEAN)");
    db.run("CREATE TABLE IF NOT EXISTS slot_requests (id INTEGER PRIMARY KEY, week TEXT, day TEXT, time TEXT, user TEXT, status TEXT)");
    db.run("CREATE TABLE IF NOT EXISTS wellness_requests (id INTEGER PRIMARY KEY, name TEXT, date TEXT)");
    db.run("CREATE TABLE IF NOT EXISTS menu_options (id INTEGER PRIMARY KEY, week TEXT, name TEXT, calories INTEGER, protein TEXT, carbs TEXT, fat TEXT, day TEXT, dietary TEXT)");
    db.run("CREATE TABLE IF NOT EXISTS weekly_calendar (id INTEGER PRIMARY KEY, week TEXT, day TEXT, time TEXT, status TEXT)");
    // db.run("CREATE TABLE IF NOT EXISTS activities (id INTEGER PRIMARY KEY, user_email TEXT, activity_type TEXT, timestamp DATETIME DEFAULT CURRENT_TIMESTAMP)");
    db.run("CREATE TABLE IF NOT EXISTS activities (id INTEGER PRIMARY KEY, user_email TEXT, activity_type TEXT, timestamp DATETIME)");
